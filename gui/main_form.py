...
class MainForm(ttk.Frame):
    ...
    def _draw_structure(self, structure: Structure | None) -> None:
        ...
        # Fixed structure viewport requested by user for easier visual comparison.
        ...
        c.create_text(tx(x_min) + 2, ty(y_min) + 2, text="X: -30..30", anchor="nw", fill="#666")
        c.create_text(tx(x_min) + 2, ty(y_min) + 16, text="Y: 0..72", anchor="nw", fill="#666")
