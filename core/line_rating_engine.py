...
class LineRatingCalc:
    ...
    def select_conductor_solve(self, is_summer: bool, conductor: Conductor, amb_temp: float, max_temperature: float) -> str:
        ...
        self.solve_steady_state_current(is_summer, amb_temp, max_temperature, cond_type)
        return ""

    def solve_steady_state_current(self, is_summer: bool, amb_temp: float, max_temperature: float, bundled_or_cond_type: str) -> None:
        temp_a = 94.0
        temp_b = 100.0

        self.model.month = 7 if is_summer else 3
